...
public class DescriptionFactorVariateArrayAdapter extends ArrayAdapter<DescriptionModel> {
	...
	public DescriptionFactorVariateArrayAdapter(Activity context, List<DescriptionModel> list,DescriptionManager descriptionManager, ObservationManager observationManager ) {
		super(context,R.layout.traitfactorvariaterow, list);
...
//		protected Button btnDelete;
	...
	public View getView(final int position, final View convertView, ViewGroup parent) {
		...
		if (this.convertView == null) {
			...
			view = inflator.inflate(R.layout.traitfactorvariaterow, null);
...
//			viewHolder.btnDelete= (Button) view.findViewById(R.id.btnDelete);
			...
			ArrayAdapter<CharSequence> adapterDatatype = ArrayAdapter.createFromResource(
					DescriptionFactorVariateArrayAdapter.this.context, R.array.datatype_choices,
...
//		if(list.get(position).getLock().equals("N")){
		...
		.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView,
				...
				if(element.isSelected()){
					...
					if(descriptionManager.getVisibleCount() > 1){
...
//				adb.setTitle("Delete?");
//				adb.setMessage("Are you sure you want to delete this added variate" );
...
//						DescriptionModel element = (DescriptionModel) holder.checkbox.getTag();
//						descriptionManager.deleteAddedVariate(element.getId());
//						observationManager.alterTableObservationDeleteColumn(element.getTraitcode());
//					}});
//				adb.show();
//			}
//		});
