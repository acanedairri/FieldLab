...
public class DecriptionConditionArrayAdapter extends ArrayAdapter<DescriptionModel> {

	private List<DescriptionModel> list;
	private Activity context;
	private DescriptionManager descriptionManager;

	public DecriptionConditionArrayAdapter(Activity context, List<DescriptionModel> list,DescriptionManager descriptionManager) {
		super(context,R.layout.traitconstantrow, list);
...
//		protected ImageView btnHide;
	...
	public View getView(final int position, final View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			view = inflator.inflate(R.layout.traitconstantrow, null);
