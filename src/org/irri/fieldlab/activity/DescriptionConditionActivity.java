...
import org.irri.fieldlab.adapter.DecriptionConditionArrayAdapter;
...
public class DescriptionConditionActivity extends ListActivity {
...
//	private static String SNAME = "";
	...
	public void onCreate(Bundle icicle) {
		...
		setContentView(R.layout.traitcondition);
		...
		databaseConnect= new DatabaseConnect(DescriptionConditionActivity.this, databaseName);
		databaseConnect.openDataBase();
		descriptionManager=new DescriptionManager(databaseConnect.getDataBase());

		ArrayAdapter<DescriptionModel> adapter = new DecriptionConditionArrayAdapter(DescriptionConditionActivity.this,
	...
	private List<DescriptionModel> getStudyVariate() {
		...
		Cursor cursorCondition = descriptionManager.getCondition();
