...
import org.irri.fieldlab.adapter.DescriptionVariateArrayAdapter;
...
public class DescriptionVariateActivity extends ListActivity {
...
//	private static String SNAME = "";
	...
	public void onCreate(Bundle icicle) {
		...
		setContentView(R.layout.traitvariate);
...
//			SNAME=extras.getString("SNAME");
		...
		databaseConnect= new DatabaseConnect(DescriptionVariateActivity.this, databaseName);
		...
		ArrayAdapter<DescriptionModel> adapter = new DescriptionVariateArrayAdapter(DescriptionVariateActivity.this,
	...
	private List<DescriptionModel> getStudyVariate() {
		...
		Cursor cursorTrait = descriptionManager.getVariate();
		int i=0;
		...
		if (cursorTrait.moveToFirst()){
			...
			do {
				...
				list.add(get(
						...
						cursorTrait.getString(15), // visible
						scoring));
