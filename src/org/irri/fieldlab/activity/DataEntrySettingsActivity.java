...
public class DataEntrySettingsActivity extends Activity {
...
//	private Spinner spinnerDataEntryFormView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dataentrysettings);
		...
		databaseConnect= new DatabaseConnect(DataEntrySettingsActivity.this, databaseName);
		...
		ArrayAdapter<String> adapterSearchReference = new ArrayAdapter<String>(DataEntrySettingsActivity.this, android.R.layout.simple_spinner_item, getStudyFactor());
...
//	}
	...
	protected void saveSettings() {
		// TODO Auto-generated method stub
		int dataentryview=1;//spinnerDataEntryFormView.getSelectedItemPosition();
