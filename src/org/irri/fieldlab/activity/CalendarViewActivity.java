...
//				Toast.makeText(getBaseContext(),"calendar ID "+String.valueOf(currentEditTextId), Toast.LENGTH_SHORT).show();
				...
				btnToday = (Button) this.findViewById(R.id.btnToday);
...
//						Toast.makeText(getBaseContext(),dateFormat.format(new Date()), Toast.LENGTH_SHORT).show();
						...
						try
							{
								...
								String dateSelected=dateFormat.format(parsedDate);
